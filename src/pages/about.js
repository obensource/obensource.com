...
const About = () => (
  <Layout>
    ...
    <div style={{display: `flex`, flexDirection: `column`, alignItems: `center`, marginTop: `80px`}}>
      <h2>
        <span role="img">📍</span>
        <OutboundLink className="link" href="https://twitter.com/obensource">BEN MICHEL</OutboundLink>'S PERSONAL RESIDENCE IN <OutboundLink className="link" href="https://www.youtube.com/watch?v=U_o8gerare0#t=6m06s">CYBERVILLE</OutboundLink>
      </h2>
