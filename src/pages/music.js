...
const Music = () => (
  <Layout>
    ...
    <div style={{display: `flex`, flexDirection: `column`, alignItems: `center`, marginTop: `80px`}}>
      ...
      <iframe width="640px" height="360px" scrolling="no" frameBorder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/28231657&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
      <iframe width="640px" height="360px" src="https://www.youtube.com/embed/uKTDxSpLDGA" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      <iframe width="640px" height="120px" src="https://bandcamp.com/EmbeddedPlayer/album=1047409309/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/artwork=small/transparent=true/" seamless><a href="http://benmichel.bandcamp.com/album/field-recordings-demos">Field Recordings (Demos) by Ben Michel</a></iframe>
      <h3 style={{marginTop: `60px`}}>Live</h3>
      <iframe width="640px" height="360px" src="https://www.youtube.com/embed/YpJzpi0W0No" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      <iframe src="https://player.vimeo.com/video/100338921" width="640px" height="360px" frameBorder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen></iframe>
      ...
      <h3 style={{marginTop: `60px`}}>WebSound</h3>
        <iframe width="640px" height="360px" src="https://www.youtube.com/embed/3PrbBHiTeDs" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
          <iframe width="640px" height="360px" src="https://www.youtube.com/embed/KeRg_RyLiUY" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            <iframe width="640px" height="360px" src="https://www.youtube.com/embed/SmoPisZ2ifw" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      ...
      <iframe width="640px" height="360px" src="https://www.youtube.com/embed/9B-iQ5yk5tw" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      <div style={{margin: `20px 0`}}>An Evening with Dot Matrix</div>
      <iframe width="640px" height="360px" src="https://www.youtube.com/embed/YxFh5QJul7s" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
